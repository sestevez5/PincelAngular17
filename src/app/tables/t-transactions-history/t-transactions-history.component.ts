...
@Component({
    selector: 'app-t-transactions-history',
    standalone: true,
    imports: [MatCardModule, MatMenuModule, MatButtonModule, RouterLink, MatTableModule, MatPaginatorModule],
    templateUrl: './t-transactions-history.component.html',
    styleUrl: './t-transactions-history.component.scss'
})
export class TTransactionsHistoryComponent {
